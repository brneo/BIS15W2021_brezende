...
heartrate3 <- heartrate2 %>% 
  ...
  pivot_longer(-c(patient, sex),
               names_to = "drug",
               values_to = "heartrate"
               ) #can leave hanging, doesn't matter
```
...
gene_exp %>% 
  pivot_wider(names_from = "type",
              values_from = "L4_values") #still not tidy because treatment and control are still part of the data 
```
...
#still not tidy because column names still represent data 
```
