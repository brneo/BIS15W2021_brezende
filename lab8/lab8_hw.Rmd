...
Based on the exploratory analysis done, it is clear that this data isn't "tidy". I can conclude that this data isn't tidy due to several of the column names are actually variables such as date, longitude, latitude, and the cfu column of enterococci. It appears that the data is in long format. 
