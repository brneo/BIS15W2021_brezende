...
ui <- fluidPage(
    ...
    sliderInput("fontsize", "Select the Font Size", min = 10, max = 24, value = 18, step = 1),  #aesthetic feature 
...
ui <- dashboardPage(
  dashboardHeader(),
  dashboardSidebar(),
  dashboardBody() #sometimes you dont need to put anything so it won't display. bare bones. it make a nice background in which you can load other information. 
)
